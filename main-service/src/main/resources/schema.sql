DROP TABLE IF EXISTS comments, compilation_event_link, compilations, participant_requests, events, categories, users;
...
CREATE INDEX ix_comments_users on comments (author_id);
CREATE INDEX ix_comments_events on comments (event_id);